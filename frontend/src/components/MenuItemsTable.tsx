        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-forkast-green-500 focus:border-transparent"
            />
            {searchQuery && (
              <button
          ...
          <div className="sm:w-48">
            <select
              ...
              className="block w-full px-3 py-2 border border-gray-300 rounded-lg text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-forkast-green-500 focus:border-transparent bg-white"
            >
